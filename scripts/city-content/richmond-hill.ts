...
export const cityServiceContent: CityServiceContent[] = [
  {
    ...
    painPoints: [
      'Korean and Chinese rental networks are invisible to English-only landlords, leaving the highest-quality applicant pool untapped',
      'Mackenzie Health employees are actively seeking rentals near the hospital but rarely find landlords who proactively reach out to them',
      'Families willing to pay school-district premiums need catchment confirmation before committing — landlords who can\'t provide this lose them to competitors who can',
    ],
    benefits: [
      { icon: 'users', text: 'Bilingual outreach in Korean and Mandarin reaches Richmond Hill\'s largest renter demographics' },
      { icon: 'star', text: 'Mackenzie Health employee targeting delivers income-stable healthcare workers directly to your vacancy' },
      { icon: 'home', text: 'School catchment-aware listing strategy attracts premium-paying families who stay long-term' },
      { icon: 'clock', text: 'Multi-channel simultaneous launch cuts average days-to-lease significantly versus single-platform listing' },
    ],
    howItWorks: [
      { step: 1, title: 'Property & Catchment Assessment', description: 'We map your unit to its exact school catchment, note proximity to Mackenzie Health and Langstaff GO, and establish a market-rate price backed by current Richmond Hill comps.' },
      { step: 2, title: 'Bilingual Multi-Channel Launch', description: 'Your listing goes live on English platforms, Korean-language social media groups, Mandarin-facing rental networks, and Mackenzie Health employee channels simultaneously.' },
      { step: 3, title: 'Pre-Screened Showing Queue', description: 'We pre-qualify every inquiry — income verification, employment type, school enrollment plans — so every showing is with a serious, qualified applicant.' },
      { step: 4, title: 'Lease Execution & Handoff', description: 'We prepare the Ontario Standard Lease with any required addenda, collect first and last month\'s rent, and hand off a fully documented tenancy.' },
    ],
    testimonial: {
      name: 'Linda Chen',
      role: 'Landlord, Hillcrest Corridor',
  ...
  },
  {
    ...
    painPoints: [
      'Accidental landlords managing single-family homes lack the systems and legal knowledge to handle maintenance, tenancy disputes, and rent increases correctly',
      'Off-season vacancies in January and February are costly when lease timing isn\'t aligned to Richmond Hill\'s family-driven school-year rental calendar',
      'Landlords unaware of the Langstaff corridor transformation are underpricing assets in appreciating corridors and overpricing in softening pockets',
    ],
    benefits: [
      { icon: 'shield', text: 'Full legal compliance — Ontario Standard Lease, RTA notices, rent increase rules — handled correctly from the start' },
      { icon: 'home', text: 'Single-family and basement suite expertise, not condo-focused management transplanted to the wrong property type' },
      { icon: 'chart', text: 'Langstaff corridor appreciation tracking informing annual rent strategy and lease renewal decisions' },
      { icon: 'clock', text: 'School-year lease calendar alignment reduces off-season vacancies and maximizes summer leasing exposure' },
    ],
    howItWorks: [
      { step: 1, title: 'Onboarding & Compliance Audit', description: 'We review your existing lease, rent history, and property condition, flag any compliance gaps, and establish a documented management baseline.' },
      { step: 2, title: 'Tenant Relations Setup', description: 'We introduce ourselves to your tenant, establish preferred communication channels — including Korean or Mandarin if applicable — and set up digital rent collection.' },
      { step: 3, title: 'Ongoing Operations', description: 'Monthly rent collection, maintenance coordination, inspection scheduling, and regulatory notices handled end-to-end with full documentation.' },
      { step: 4, title: 'Annual Strategy Review', description: 'Each year we review market rents, Langstaff corridor developments, school catchment demand signals, and recommend lease renewal or rent increase strategy.' },
    ],
    testimonial: {
      name: 'Mi-Young Park',
      role: 'Landlord, North Richvale',
  ...
  },
  {
    ...
    painPoints: [
      'Immigrant families unfamiliar with Canadian digital payment systems create avoidable friction if payment setup is not handled properly at lease commencement',
      'Late formal notice issuance surrenders weeks of legal advantage — Bill 60\'s reduced N4 window only helps landlords who actually use it promptly',
      'Informal cash or cheque rent collection leaves landlords without documented payment history for LTB proceedings or mortgage qualification purposes',
    ],
    benefits: [
      { icon: 'clock', text: 'Same-day N4 issuance under Bill 60\'s 7-day threshold — no waiting, no hesitation, full documentation' },
      { icon: 'users', text: 'Bilingual payment onboarding in Korean and Mandarin eliminates first-month friction with immigrant tenant households' },
      { icon: 'document', text: 'Complete digital payment history maintained for CRA reporting, LTB evidence, and mortgage qualification' },
      { icon: 'shield', text: 'Clear payment policy communicated in tenant\'s preferred language at lease signing reduces ambiguity disputes' },
    ],
    howItWorks: [
      { step: 1, title: 'Payment System Onboarding', description: 'At lease commencement, we walk every tenant through the digital payment platform in their preferred language — English, Korean, or Mandarin — and confirm the first payment before move-in.' },
      { step: 2, title: 'Monthly Collection & Reconciliation', description: 'Rent is collected on the first of each month, reconciled against the lease record, and posted to your landlord dashboard with confirmation of receipt.' },
      { step: 3, title: 'Early Intervention Protocol', description: 'Unpaid rent on the second of the month triggers a polite but firm reminder. By the eighth day of non-payment, an N4 notice is prepared and served without waiting for landlord instruction.' },
      { step: 4, title: 'Escalation & Documentation', description: 'If the N4 void period passes without payment, we prepare the L1 application package for LTB filing and present it to you with a recommended next step.' },
    ],
    testimonial: {
      name: 'Jason Kim',
      role: 'Landlord, Doncrest',
  ...
  },
  {
    ...
    painPoints: [
      'Single-family home maintenance — exterior, HVAC, roof, basement suites — requires a completely different trades network than condo-focused management companies provide',
      'Mackenzie Health worker tenants expect same-day emergency response and will not tolerate landlords who are slow to act on habitability issues',
      'Neglected seasonal maintenance along the Highway 404 corridor leads to preventable emergency repairs and costly property damage every winter',
    ],
    benefits: [
      { icon: 'clock', text: '24/7 emergency maintenance line with same-day York Region trades dispatch for Mackenzie Health worker tenants' },
      { icon: 'home', text: 'Single-family and basement suite maintenance expertise — exterior, HVAC, plumbing, roof — not condo-specific' },
      { icon: 'shield', text: 'Proactive seasonal maintenance packages prevent costly winter emergencies along the Highway 404 corridor' },
      { icon: 'check', text: 'All repairs documented with photos, invoices, and completion confirmations for your records and CRA deductibility' },
    ],
    howItWorks: [
      { step: 1, title: 'Initial Property Condition Assessment', description: 'We inspect the full property — exterior, HVAC, plumbing, electrical panels, basement suite — and produce a prioritized maintenance list with estimated costs.' },
      { step: 2, title: 'Preventive Maintenance Scheduling', description: 'We set up recurring service appointments: furnace servicing, exterior checks, eavestrough cleaning, and winterization — all scheduled automatically without landlord reminders.' },
      { step: 3, title: 'Tenant Request Handling', description: 'Tenants submit requests through a digital portal or phone line. We triage, dispatch the appropriate trade, and update the tenant and landlord on status throughout.' },
      { step: 4, title: 'Repair Documentation & Billing', description: 'Every completed repair is documented with before/after photos, trade invoices, and a completion report added to your property file — ready for CRA deductions and LTB evidence if needed.' },
    ],
    testimonial: {
      name: 'Helen Zhang',
      role: 'Landlord, Bayview Hill',
  ...
  },
  {
    ...
    painPoints: [
      'Credit-score-only screening systematically eliminates recently arrived Korean and Chinese professionals who are among Richmond Hill\'s most stable tenant candidates',
      'School catchment misrepresentation by multi-household families can create occupancy and registration complications if not caught before lease signing',
      'First-time immigrant renters unfamiliar with Ontario rental documentation requirements create application delays and incomplete files without structured guidance',
    ],
    benefits: [
      { icon: 'users', text: 'Culturally competent screening evaluates Korean and Chinese applicants across income, employment, and reference — not credit score alone' },
      { icon: 'check', text: 'School catchment verification before lease signing prevents occupancy misrepresentation disputes with family tenants' },
      { icon: 'document', text: 'Mackenzie Health employment verification via direct confirmation — not self-reported pay stubs alone' },
      { icon: 'shield', text: 'First-time renter onboarding for new immigrants builds a transparent tenancy foundation from day one' },
    ],
    howItWorks: [
      { step: 1, title: 'Application Collection & Translation Support', description: 'We provide application forms with Korean and Mandarin guidance notes and assist new immigrant applicants in assembling required documentation in the correct format.' },
      { step: 2, title: 'Income & Employment Verification', description: 'We verify income through pay stubs, employment letters, and direct employer confirmation — including Mackenzie Health HR verification for hospital employee applicants.' },
      { step: 3, title: 'Credit & Reference Assessment', description: 'Credit reports are assessed in context of Canadian tenure, supplemented by international reference letters and rental history where applicable. We do not disqualify on thin credit alone.' },
      { step: 4, title: 'Catchment & Occupancy Disclosure', description: 'For family applicants, we confirm school catchment alignment, intended occupancy, and document the disclosure in a signed lease addendum before execution.' },
    ],
    testimonial: {
      name: 'Robert Yoo',
      role: 'Landlord, Oak Ridges',
  ...
  },
  {
    ...
    painPoints: [
      'One-year leases that expire mid-school year are a structural mismatch with Richmond Hill family tenant preferences — the wrong lease term increases turnover and vacancy risk',
      'Missing school catchment addenda leave landlords exposed to disputes with families who claim the rental was represented as being in a specific catchment',
      'Incorrect rent increase calculations or wrong notice form selection can invalidate an increase entirely, costing landlords months of foregone revenue',
    ],
    benefits: [
      { icon: 'document', text: 'Long fixed-term family lease structures aligned to the school-year calendar reduce turnover and attract premium-paying tenants' },
      { icon: 'shield', text: 'School catchment disclosure addendum protects landlords from misrepresentation claims by catchment-seeking family tenants' },
      { icon: 'chart', text: 'Post-2018 rent increase exemption tracking ensures correct N1/N2 notice form, amount, and timing every cycle' },
      { icon: 'check', text: 'Full RTA compliance across all notice types — N1, N2, N4, N12 — with proper service documentation maintained' },
    ],
    howItWorks: [
      { step: 1, title: 'Lease Drafting & Addenda', description: 'We prepare the Ontario Standard Lease plus all required addenda — school catchment disclosure, parking, utilities, maintenance responsibilities — tailored to the specific unit and tenant profile.' },
      { step: 2, title: 'Bilingual Lease Review', description: 'For Korean or Chinese-speaking tenants, we walk through the lease in their preferred language before signing, confirming understanding of key terms without modifying the English legal document.' },
      { step: 3, title: 'Rent Increase Tracking', description: 'We maintain an annual calendar for each tenancy, calculating guideline increases for pre-2018 units and above-guideline potential for exempt post-2018 units, with N1/N2 notices prepared 90 days before the intended effective date.' },
      { step: 4, title: 'Renewal & Transition Management', description: 'At term end, we assess market rents against current lease rate, recommend renewal terms or new-tenant strategy, and execute renewals or transition to monthly tenancy with appropriate documentation.' },
    ],
    testimonial: {
      name: 'Sarah Moon',
      role: 'Landlord, Alexander Mackenzie Catchment',
  ...
  },
  {
    ...
    painPoints: [
      'Single-family landlords systematically underestimate maintenance costs by excluding irregular lifecycle expenses — furnace, roof, appliances — from their net income calculations',
      'Langstaff corridor appreciation is invisible to landlords who only look at current rent comps and ignore the development pipeline reshaping long-term demand',
      'School district premium is a measurable, quantifiable rent advantage that most landlords never see reported — and therefore never fully capture at lease renewal',
    ],
    benefits: [
      { icon: 'chart', text: 'Langstaff corridor development tracking incorporated into annual rent strategy and appreciation analysis' },
      { icon: 'document', text: 'CRA T776 rental income schedule prepared with full maintenance cost allocation and capital expense categorization' },
      { icon: 'home', text: 'School district premium quantification — your catchment advantage measured and reported in dollar terms' },
      { icon: 'shield', text: 'Full lifecycle maintenance cost modelling ensures your NOI figure reflects true economic performance, not just cash collected' },
    ],
    howItWorks: [
      { step: 1, title: 'Financial Baseline Setup', description: 'We establish your opening property value, mortgage balance, tax assessment, and historical maintenance costs to build a complete financial model from the start.' },
      { step: 2, title: 'Monthly Income & Expense Reporting', description: 'Each month you receive a clear income and expense statement: rent collected, maintenance costs, management fees, and any vacancy loss — formatted for CRA T776 alignment.' },
      { step: 3, title: 'Annual Rent & Market Analysis', description: 'Each year we produce a Richmond Hill market report for your specific catchment zone, quantifying the school district premium, Langstaff corridor trajectory, and recommended rent adjustment for renewal.' },
      { step: 4, title: 'CRA Reporting Package', description: 'At year end, we deliver a complete T776 rental income schedule with all deductible expenses categorized, capital expense vs. current expense distinctions flagged, and documentation of maintenance invoices.' },
    ],
    testimonial: {
      name: 'Peter Chan',
      role: 'Landlord, Langstaff Corridor',
  ...
  },
  {
    ...
    painPoints: [
      'Family tenants experiencing income disruption often go silent rather than communicate proactively — landlords who wait for the tenant to raise the issue lose weeks of intervention time',
      'Procedural errors in N4 notices or L1 applications require refiling from scratch, adding months to an already backlogged LTB process',
      'Landlords unfamiliar with Bill 60\'s reduced N4 window are still waiting 15 days before acting — surrendering weeks of legal advantage every time',
    ],
    benefits: [
      { icon: 'clock', text: 'Bill 60 N4 issued on day 8 of default — no delays, no waiting for landlord instruction, full service documentation' },
      { icon: 'users', text: 'Early Korean and Mandarin outreach at first sign of difficulty — many Richmond Hill arrears situations resolved before N4 is needed' },
      { icon: 'document', text: 'LTB-ready L1 application package prepared with complete documentation of lease, payment history, and notice service' },
      { icon: 'shield', text: 'Correct form selection and procedural compliance the first time — no refiling, no clock resets, no avoidable delays' },
    ],
    howItWorks: [
      { step: 1, title: 'Early Intervention Contact', description: 'At the first missed payment, we contact the tenant in their preferred language — English, Korean, or Mandarin — to understand what is driving the arrears and whether a short-term resolution is possible without formal proceedings.' },
      { step: 2, title: 'N4 Issuance on Day 8', description: 'If the payment is not received and no acceptable resolution is established, we prepare and serve the N4 Notice to End Tenancy for Non-payment on the eighth day of default, with documented service method and timestamp.' },
      { step: 3, title: 'Void Period Monitoring', description: 'We monitor the 14-day void period. If the tenant pays all arrears within the void period, we close the notice and document the resolution. If not, we proceed immediately to L1 preparation.' },
      { step: 4, title: 'LTB Application Package', description: 'We prepare the complete L1 application — all exhibits, service documentation, payment history — and present it to you with a recommended filing strategy and LTB hearing preparation guidance.' },
    ],
    testimonial: {
      name: 'Grace Lee',
      role: 'Landlord, North Richvale',
