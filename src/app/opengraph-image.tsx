    ...
    (
      <div
        style={{
          ...
          height: '100%',
          background:
            'radial-gradient(circle at 15% 85%, rgba(0,153,102,0.28) 0%, rgba(0,30,87,0) 55%), radial-gradient(circle at 85% 10%, rgba(212,168,83,0.22) 0%, rgba(0,30,87,0) 55%), #001E57',
          padding: '80px 96px',
          color: '#FBFAF6',
