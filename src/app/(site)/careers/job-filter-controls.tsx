  ...
  return (
    <div className="space-y-4">
      <div className="relative w-full">
        ...
        <input
          type="text"
          className="block w-full rounded-xl border-0 py-4 pl-11 pr-16 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-[var(--brand-emerald)] sm:text-sm sm:leading-6"
        ...
        {search && (
          <div className="absolute inset-y-0 right-2 flex items-center">
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 text-slate-500 hover:bg-[var(--brand-emerald)] hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--brand-emerald)] focus:ring-offset-2"
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <div className="relative" ref={locationRef}>
          ...
          >
            Location {totalLocationSelected > 0 && <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[var(--brand-emerald)] text-[10px] text-white">{totalLocationSelected}</span>}
            ...
            <div className="absolute left-0 z-10 mt-2 w-72 origin-top-left rounded-xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none flex flex-col max-h-[400px]">
              <div className="p-2 border-b border-slate-100 shrink-0">
                <div className="relative">
                  ...
                  <input 
                    type="text"
                    className="block w-full rounded-md border-0 py-2 pl-9 pr-3 text-sm text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-[var(--brand-emerald)]"
                  ...
                  return (
                    <div key={h.country} className="space-y-1">
                      <label className="flex cursor-pointer items-center gap-3 rounded-lg px-2 py-1.5 hover:bg-slate-50">
                        <input
                          type="checkbox"
                          className="h-4 w-4 rounded border-slate-300 text-[var(--brand-emerald)] focus:ring-[var(--brand-emerald)] accent-[var(--brand-emerald)]"
        ...
        <div className="relative" ref={categoryRef}>
          ...
          >
            Job Category {selectedCategories.length > 0 && <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[var(--brand-emerald)] text-[10px] text-white">{selectedCategories.length}</span>}
            <ChevronDown className="h-4 w-4 text-slate-400" />
          </button>
          {categoryOpen && (
        ...
        {(totalLocationSelected > 0 || selectedCategories.length > 0 || search) && (
          <button
            ...
            className="px-4 py-3 text-sm font-medium text-[var(--brand-emerald)] hover:text-[var(--brand-emerald)]/80 transition-colors"
          >
            Clear all
          </button>
        )}
